...
@interface GuoWaiViewController ()<UICollectionViewDataSource,UICollectionViewDelegate>{
...
- (void)loadNetData {
    ...
    [manager GET:WANTPLACEURL parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        for (PlaceElementModel *pmodel in model.elements) {
            if ([pmodel.title isEqualToString:@"美洲和大洋洲"]||[pmodel.title isEqualToString:@"欧洲国家"]||[pmodel.title isEqualToString:@"亚洲国家"]) {
